...
3. Save checkpoints to `v3/runs/` (every `ep_length // 2` steps)
4. Log to TensorBoard in `v3/runs/`
...
All other dependencies are shared with V2 (see `requirements/requirements-v3.txt`).
...
├── agent_enabled.txt          # Runtime AI toggle
